...
This plugin enhance [Simple metadata](https://github.com/my-language-skills/simple-metadata) with annotations related metadata.
...
1. Upload the plugin files to the `/wp-content/plugins/simple-metadata-annotation` directory, or install the plugin
...
As Simple metadata annotation is an extension of Simple metadata, visit the [Simple metadata](https://github.com/my-language-skills/simple-metadata) page at the Wordpress plugin repository or the [Simple metadata FAQ](https://github.com/my-language-skills/simple-metadata) page at GitHub to find all the information.
...
The Simple metadata annotation is supplied "as is" and all use is at your own risk.
